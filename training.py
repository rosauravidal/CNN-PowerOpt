...
cifar10classepoch_json = model.to_json()
with open("cifar10classification_top5.json", "w") as json_file:
    json_file.write(cifar10classepoch_json)
# serialize weights to HDF5
model.save_weights("cifar10classification_top5.h5")
